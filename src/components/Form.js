        ...
        <>
            <div className='w-full h-screen bg-gray-700'>
               ...
               focus:outline-none focus:shadow-outline" id="contact" name='contact' type="number" value={contact} onChange={(e) => setContact(e.target.value)} placeholder="093723232" />
                        ...
                        {Loading ? (
                            <button disabled type="button" className="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 inline-flex items-center">
